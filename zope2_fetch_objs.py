...
#
# - Copy zoperope_support lib into somewhere in your Zope instances Python module include
#   path (ie. bin/lib/ within your Zope instance folder)
...
#from zoperope_support_lib import *
